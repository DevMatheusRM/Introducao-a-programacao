#Boletim Escolar: No final do ano letivo, um professor precisa calcular a média final de cada aluno e determinar se ele foi
#aprovado ou reprovado. Para isso, ele tem as notas de cada bimestre. Ajude o professor criando um programa que calcule
#a média final e informe se o aluno foi aprovado (média maior ou igual a 60) ou reprovado.
